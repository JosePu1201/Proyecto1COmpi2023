...
"player_color"          {return new Symbol(sym.COLOR_JUGADOR,yyline+1,yycolumn+1,yytext());}
...
"undefined_color"       {return new Symbol(sym.UNDEFINED_COLOR,yyline+1,yycolumn+1,yytext());}
...
"HALL"                  {return new Symbol(sym.TIPO,yyline+1,yycolumn+1,yytext());}
"BRICK"                 {return new Symbol(sym.TIPO1,yyline+1,yycolumn+1,yytext());}
...
"*"                     {return new Symbol(sym.MULTIPLICAR,yyline+1,yycolumn+1,yytext());}
"-"                     {return new Symbol(sym.MENOS,yyline+1,yycolumn+1,yytext());}
"/"                     {return new Symbol(sym.DIAGONAL,yyline+1,yycolumn+1,yytext());}
"^"                     {return new Symbol(sym.POTENCIA,yyline+1,yycolumn+1,yytext());}
